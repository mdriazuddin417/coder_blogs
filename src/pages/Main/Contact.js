    ...
    <div>
      <div class="container my-5 px-6 mx-auto">
        <section class="mb-32 text-gray-800">
          <div
            class="relative overflow-hidden bg-no-repeat bg-cover rounded"
            style={{
          ...
          "
                  ...
                  <div class="form-group form-check text-center mb-6 flex items-center justify-center">
                    <Checkbox defaultChecked id="exampleCheck87" />
                    <label
