...
import img from "../../image/layers.png";
            ...
            <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                <form class="w-full" onSubmit={() => {}}>
                  ...
                  <div class="lg:border md:border border-gray-100 rounded-full p-2 lg:focus-within:ring sm:flex sm:items-center sm:gap-4">
                    <input
                      type="email"
                      id="UserEmail"
                      placeholder="john@rhcp.com"
                      class="w-full lg:border-none md:border-none lg:focus:border-transparent lg:focus:ring-transparent sm:text-sm outline-none text-lg pl-5 border-blue-500 border py-2 rounded-full"
                    />

                    <Button className="rounded-full lg:mt-0 md:mt-0 mt-2">
                      Submit
                    </Button>
                  </div>
                </form>
              ...
              {footerData.map((data) => (
                <div class="col-span-2 sm:col-span-1">
                  <p class="font-semibold text-gray-900 hover:text-light-blue-500">
                    {data.title}
                  </p>
              ...
              <ul class="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
                ...
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    class="text-[#171515] transition hover:opacity-75"
                  >
                ...
                <li>
                  <a
                    ...
                    rel="noreferrer"
                    target="_blank"
                    class="text-[#ea4c89] transition hover:opacity-75"
                  >
